...
function List() {
    ...
    return (
        ...
        <nav class="navbar bg-body-tertiary">
            ...
            <center>                        <h2  style={{ fontFamily: 'serif' }}>Your Bookings</h2>
            </center>
            <div className='d-flex justify-content-evenly mt-5'>
                {bookings.map((booking, index) => (
                    ...
                    <div key={index} className="card2 ">
                        ...
                        <span className='mt-2'>{booking.movieName}</span>
                        <span className='mt-2'>Time:{booking.time}</span>
                        <span className='mt-2'>Theatre: {booking.theaterName}</span>
                        <span className='mt-2'>seat:{booking.selectedSeats.join(', ')}</span>
