        ...
        <div className="registration-form">
          ...
          <form style={{ marginTop: '200px' }}  >
            ...
            <div className='mt-3'>
              ...
              <p style={{ marginLeft: '50px' }} className='text-dark'>  Don't have an account?  <Link style={{ color: "blue", textDecoration: 'none' }} to={'/register'}>Register</Link>  </p>
              {/* :
          ...
          <div style={{ marginTop: '55px' }}>
            <Button onClick={handleLoginClick} style={{ width: '100px', marginLeft: '100px', backgroundColor: 'white', color: 'black' }} variant="contained">Login</Button>
          </div>
        </div>
      </div>
      <ToastContainer />
